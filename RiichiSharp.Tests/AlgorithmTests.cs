...
public class ScoringTests
{
    ...
    public void Full_Pipeline_Riichi_Tsumo()
    {
        ...
        var waitTypes = RiichiSharp.Wait.WaitDetector.Detect(structure, Tile.S4);
        var yaku = RiichiSharp.Yaku.YakuDetector.Detect(structure, tiles!.Value, context, waitTypes);
        var fu = RiichiSharp.Scoring.FuCalculator.Calculate(structure, context, waitTypes);
